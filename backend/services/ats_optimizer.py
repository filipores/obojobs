...
class ATSOptimizer:
    ...
    def analyze_cover_letter(self, cover_letter_text: str, job_description: str) -> dict:
        """
        ...
        try:
            ...
            return self._parse_analysis_response(data, cover_letter_text)
        except ValueError:
            raise
        except Exception as e:
            raise Exception(f"ATS optimization analysis failed: {str(e)}") from e
...
Antworte NUR mit dem JSON, keine zusätzlichen Erklärungen."""
    ...
    def _parse_analysis_response(self, data: dict, cover_letter: str) -> dict:
        """Parse the API response dict and calculate ATS score."""
...
def analyze_cover_letter_ats(cover_letter_text: str, job_description: str) -> dict:
    """
