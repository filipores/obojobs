...
Schreibe NUR den Einleitungsabsatz (2-4 Sätze) im lockeren, authentischen Stil von Filip. Beginne direkt mit dem Text, ohne Anrede."""
    ...
    def generate_email_text(self, position: str, ansprechperson: str, attachments: list = None) -> str:
...
anbei finden Sie meine Bewerbungsunterlagen für die Position als {position}.
