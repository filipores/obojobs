        ...
        <form v-else @submit.prevent="handleSubmit" class="auth-form">
          ...
          <div class="form-group">
            ...
            <div class="password-requirements" aria-live="polite" aria-atomic="false">
              <p class="requirements-label" id="reset-password-requirements-label">Passwort-Anforderungen:</p>
              <ul class="requirements-list" aria-labelledby="reset-password-requirements-label">
