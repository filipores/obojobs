  ...
  <div class="salary-coach">
    ...
    <div v-else class="input-section zen-card">
      ...
      <div class="action-buttons">
        <button
          ...
          class="zen-btn"
          aria-label="Gehalt recherchieren - Marktdaten für die eingegebene Position abrufen"
        >
        ...
        <button
          ...
          aria-label="Verhandlungsstrategie generieren - KI-gestützte Tipps für Gehaltsverhandlungen"
        >
    ...
    <div v-if="!isLoading && strategy" class="strategy-section animate-fade-up">
      ...
      <div class="tips-section zen-card">
        ...
        <!-- Category Filter -->
        <div class="category-tabs" role="tablist" aria-label="Tipps nach Kategorie filtern">
          <button
            ...
            :aria-label="`${cat.label} - ${getTipsForCategory(cat.key).length} Tipps`"
          >
