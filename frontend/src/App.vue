<template>
  <div id="app" :class="{ 'dark-mode': isDarkMode }">
    ...
    <nav v-if="authStore.isAuthenticated()" class="zen-nav">
      <div class="nav-container">
        ...
        <div class="nav-center" :class="{ 'nav-resizing': isResizing }">
          ...
          <router-link to="/job-dashboard" class="nav-link" active-class="active" title="Jobsuche">
        ...
        <div class="nav-actions">
          ...
          <!-- Settings -->
          <router-link to="/settings" class="nav-icon settings-link" title="Einstellungen">
    ...
    <div v-if="authStore.isAuthenticated()" class="mobile-sidebar" :class="{ 'sidebar-open': isSidebarOpen }">
      ...
      <div class="sidebar-content">
        ...
        <nav class="sidebar-nav">
          <router-link to="/new-application" class="sidebar-link sidebar-cta" @click="closeMobileSidebar">
          ...
          <router-link to="/profil" class="sidebar-link" active-class="active" @click="closeMobileSidebar">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
              <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />
              <circle cx="12" cy="7" r="4" />
            </svg>
            <span>Persönlichkeitsprofil</span>
          </router-link>
          ...
          <router-link to="/applications?view=timeline" class="sidebar-link" active-class="active" @click="closeMobileSidebar">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
    ...
    <!-- Breadcrumbs -->
    <div v-if="authStore.isAuthenticated() && showBreadcrumbs" class="breadcrumb-container">
      <div class="container">
        <BreadcrumbNav />
      </div>
    </div>
    ...
    <nav v-if="authStore.isAuthenticated()" class="bottom-nav" aria-label="Mobile Navigation">
      ...
      <router-link to="/job-dashboard" class="bottom-nav-item" active-class="active" title="Jobsuche">
        <svg class="bottom-nav-icon" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
          <circle cx="11" cy="11" r="8"/>
          <path d="M21 21l-4.35-4.35"/>
        </svg>
      ...
      <router-link to="/settings" class="bottom-nav-item" active-class="active" title="Profil">
        <svg class="bottom-nav-icon" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
          <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/>
          <circle cx="12" cy="7" r="4"/>
        </svg>
...
@media (max-width: 767px) {
  ...
  /* Hide settings and logout from top nav on mobile - accessible via bottom nav / Profil */
  .nav-actions .settings-link,
  .nav-actions .logout {
    display: none;
  }
}
